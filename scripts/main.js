const svgPicker = document.getElementById("svg-container");
const inputColor = document.getElementById("input-color");
const htmlColor = document.getElementById("html");
